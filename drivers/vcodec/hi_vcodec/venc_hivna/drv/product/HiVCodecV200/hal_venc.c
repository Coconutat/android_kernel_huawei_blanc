...
HI_VOID vedu_hal_cfg_reg_addr_set(struct encode_info *channel_cfg, HI_U32 *reg_base)
{
	...
	//   all_reg->VEDU_VCPI_NBI_UPST_ADDR = channel_cfg->all_reg..u32;
	//}
...
HI_VOID vedu_hal_cfg_reg(struct encode_info *channel_cfg, HI_U32 *reg_base, HI_BOOL *first_cfg_flag)
{
	...
	/*	   //sec reg
	    {
	        all_reg->VEDU_VCPI_INTMASK_S.u32 = channel_cfg->all_reg.VEDU_VCPI_INTMASK_S.u32;
	    }

	    {
	        all_reg->VEDU_VCPI_INTCLR_S.u32 = channel_cfg->all_reg.VEDU_VCPI_INTCLR_S.u32;
	    }
	*/
