...
static void init_freq_update_status(struct platform_device *pdev)
{
	...
	set_slimbus_soc_div_freq_disable(soc_clk1_div_freq_disable);

	pr_info("[%s:%d] soc div diable:%d\n", __FUNCTION__, __LINE__, soc_clk1_div_freq_disable);
